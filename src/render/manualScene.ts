/**
 * No-AI mode: the customer taps the countertops on their own photo.
 *
 * The photo is split into colour-coherent regions in the browser (the same
 * segmentation the server uses for Claude's grounding, shared/segmentation.ts),
 ...
 */
import { defaultScene, sanitizeScene, type SceneAnalysis, type StoneSurface } from "../../shared/scene";
import { segmentRgb, surfaceFromRegions, type Segmentation } from "../../shared/segmentation";
